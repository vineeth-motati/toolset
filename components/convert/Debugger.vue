        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div>
                ...
                >
                    <p
                        :class="
                            testResult.found ? 'text-green-700' : 'text-red-700'
                        "
                    >
                        {{
                            testResult.found
                    ...
                    <div v-if="testResult.found">
                        ...
                        <p>Source: {{ testResult.converter.sourceFormat }}</p>
                        <p>Target: {{ testResult.converter.targetFormat }}</p>
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <div v-if="apiTypeResult.found">
                            ...
                            <p>Title: {{ apiTypeResult.converter.title }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Right column -->
            <div>
                <h2 class="mb-4 text-xl font-semibold">Available Converters</h2>
                <div>
                    <input
                        v-model="filterText"
                        type="text"
